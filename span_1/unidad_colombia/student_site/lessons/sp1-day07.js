window.LESSON_DATA = {
  ...
  subtitle: "Dive deep into Colombian culture through reading stations, then choose your project topic",
  objectives: [
    "I can read about Colombian cultural topics and identify key facts",
      ...
      components: [
        {
          ...
          fields: [
            { label: "Which station was most interesting to you? Why?", type: "textarea", placeholder: "Station... was most interesting because...", rows: 2 },
            { label: "One new fact you learned today:", placeholder: "I learned that..." },
