window.LESSON_DATA = {
  ...
  title: "Project Planning (pretérito)",
  subtitle: "Define your focus, research facts, draft past-tense Spanish sentences, and assign group roles",
  objectives: [
    "I can define a clear project focus connected to Colombia",
    "I can find 3+ facts from reliable sources",
    "I can draft at least 4 accurate preterite sentences for our script"
  ],
  vocabCategory: "all",
  sections: [
    {
    ...
    },
    {
      ...
      subtitle: "Write 4 sentences in the preterite (reporting facts and past events)",
      icon: "📝",
      accent: "purple",
      components: [
        {
      ...
      components: [
        {
          ...
          fields: [
            ...
            { label: "Four preterite sentences are drafted", placeholder: "Yes / Not yet" },
